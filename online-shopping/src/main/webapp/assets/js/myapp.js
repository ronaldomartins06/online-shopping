$(function(){
	...
	if($table.length){
		...
		if(window.categoryId == ''){
			console.log('Insede jsonUrl: '+window.categoryId);
			jsonUrl = window.contextRoot + '/json/data/all/products';
			
		}else{
			jsonUrl = window.contextRoot + '/json/data/category/'+ window.categoryId +'/products';
			console.log('Insede jsonUrl 2: '+window.categoryId);
		}
	...
	$('.switch input[type="checkbox"]').on('change', function() {
		...
		bootbox.confirm({
			size: 'medium',
			title: 'Product Activetaion & Deactivation',
			message: dMsg,
			    		...
			    		bootbox.confirm({
			    			...
			    			callback: function(confirmed){
			    				...
			    				if( confirmed ){
			    					...
			    					//handling deactivation/activation product
